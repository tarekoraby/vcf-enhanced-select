...
const $_documentContainer = html`<dom-module id="material-select" theme-for="vcf-enhanced-select">
  <template>
...
</dom-module><dom-module id="material-select-text-field" theme-for="vcf-enhanced-select-text-field">
  <template>
    <style>
      :host {
        width: 100%;
...
</dom-module><dom-module id="material-select-overlay" theme-for="vcf-enhanced-select-overlay">
  <template>
    <style include="material-menu-overlay">
      ...
      [part="overlay"] {
        min-width: var(--vcf-enhanced-select-text-field-width);
      }
    </style>
  </template>
</dom-module>`;
