...
const $_documentContainer = html`<dom-module id="lumo-select" theme-for="vcf-enhanced-select">
  <template>
...
</dom-module><dom-module id="lumo-select-text-field" theme-for="vcf-enhanced-select-text-field">
  <template>
    <style>
...
</dom-module><dom-module id="lumo-select-overlay" theme-for="vcf-enhanced-select-overlay">
  <template>
